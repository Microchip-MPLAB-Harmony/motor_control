...
2. Set the motor and board parameters.
    ...
    [Click here for details](./hardware_modules/hardware_modules.md)
...
3. Set the microcontroller peripherals.
    ...
    [Click here for details](./peripheral_modules/peripheral_modules.md)
...
4. Set the software modules.
    ...
    [Click here for details](./software_modules/software_modules.md)
