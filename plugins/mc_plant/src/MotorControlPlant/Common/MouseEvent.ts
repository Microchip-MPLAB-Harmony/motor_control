...
export function CallMouseMove(evt: { target: any}, svgdoc: any, toolTipObject : any) {
...
function showTooltip(evt: { target?: any; clientX?: any; clientY?: any; }, text: any, svgdoc : any, toolTipObject : any) {
