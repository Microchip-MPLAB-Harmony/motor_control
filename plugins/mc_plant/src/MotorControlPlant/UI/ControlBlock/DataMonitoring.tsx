...
const DataMonitoring = (props :{ parentUpdate: () => void;  showToast : (arg0: any) => void ;} ) => {

    let SymbolsArray = ["MCPMSMFOC_DATA_MONITOR_ENABLE","MCPMSMFOC_DATA_MONITOR_PROTOCOL", "MCPMSMFOC_X2CScope"];
